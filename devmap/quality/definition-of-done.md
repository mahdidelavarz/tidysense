...
- xUnit domain/application tests, real-PostgreSQL Testcontainers integration tests, `WebApplicationFactory` API tests, Vitest/Testing Library behavior tests and Playwright critical-flow tests pass where applicable;
