...
| AI authority, failure, hostile input, and provider safeguards | AI/Safety |
...
| `RAM-SPEC-006` | `04-Specs/ai-guardrails.md` | Consolidated general AI/provider guardrails; dedicated crisis product flow removed | `REWRITE` completed as current guardrail specification | D013–D014A; D017–D018A; D020A–D020C; 2026-09-19 consolidation | AI/Safety + Product + Backend + Security/Privacy | before real-user AI exposure | Rewritten and semantically approved | `APPLIED_VERIFIED` |
...
| Provider safeguards/moderation, hostile-input corpus, context review and human sign-offs | AI/Safety | Product + Research + Security/Privacy | M6 testing; final M8 | real-user AI disabled; pilot blocked | ordinary AI safety/readiness gate | guardrail spec + adversarial/provider review package | `UNASSIGNED_VALUES` |
